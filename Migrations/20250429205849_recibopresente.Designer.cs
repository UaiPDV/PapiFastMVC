...
namespace BixWeb.Migrations
{
    ...
    [Migration("20250429205849_recibopresente")]
    partial class recibopresente
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BixWeb.Models.ReciboPresente", b =>
                {
                    ...
                    b.Property<int?>("convitecodConvite")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BixWeb.Models.ReciboPresente", b =>
                {
                    ...
                    b.HasOne("BixWeb.Models.Convite", "convite")
                        .WithMany("recibosPresentes")
                        .HasForeignKey("convitecodConvite");
